...
library GroupLib {
    ...
    function isGroupMember(GroupMap storage _map, uint256 _groupId, uint256 _keeperId) internal view returns (bool) {
    ...
    function keepers(GroupMap storage _map, uint256 _groupId) internal view returns (uint256[] storage) {
