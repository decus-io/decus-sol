...
module.exports = {
    ...
    networks: {
        ...
        development: {
            ...
            confirmations: 0, // number of confirmations to wait between deployments (default: 0)
            disableConfirmationListener: true, // true to disable web3's confirmation listener
        },
        kovan: {
            provider: () =>
